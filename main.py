...
class MainHandler(BaseHandler):
  def get(self):
    ...
    #    template_values={'user_login_id':self.session.get('user_login_id'),'homepage_posts':homepage_posts}
...
class Promote(BaseHandler):
    def post(self):
        ...
        #promoting_owner_name = self.request.get('promoting_repo_owner')
        ...
        #pr = PromotedRepos(key_name=promoting_repo_name,promoting_repo_stars=promoting_repo_stars,promoting_repo_forks=promoting_repo_forks,promoting_repo_language=promoting_repo_language,people=people,promoting_owner_name=promoting_owner_name,promoting_repo_name=promoting_repo_name,promoted_time=promoted_time)
        #pr.put()
        #self.redirect('http://gitpromote.appspot.com')
